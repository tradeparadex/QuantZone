...
class ParadexPerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    ...
    async def _request_order_book_snapshot(self, trading_pair: str) -> dict[str, Any]:
        ...
        data = await self._connector._api_get(path_url=f"{CONSTANTS.SNAPSHOT_REST_URL}/{ex_trading_pair}", data={})
        return data
    ...
    async def _parse_order_book_diff_message(self, raw_message: dict[str, Any], message_queue: asyncio.Queue):
        ...
        trading_pair = await self._connector.trading_pair_associated_to_exchange_symbol(raw_message["data"]["market"])
    ...
    async def _parse_order_book_snapshot_message(self, raw_message: dict[str, Any], message_queue: asyncio.Queue):
        ...
        trading_pair = await self._connector.trading_pair_associated_to_exchange_symbol(_data["market"])
    ...
    async def _parse_trade_message(self, raw_message: dict[str, Any], message_queue: asyncio.Queue):
        ...
        trading_pair = await self._connector.trading_pair_associated_to_exchange_symbol(trade_data["market"])
    ...
    async def _request_complete_funding_info(self, trading_pair: str):
        ...
        data = await self._connector._api_get(
            path_url=CONSTANTS.GET_LAST_FUNDING_RATE_PATH_URL, params={"market": ex_trading_pair}
        )
        return data
